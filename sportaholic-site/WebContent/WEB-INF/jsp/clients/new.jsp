  ...
  <body>
    ...
    <c:import url="/WEB-INF/jsp/shared/breadcrumb.jsp" />
     ...
     <div class="center-form">
        <form:form class="form-horizontal" action="/clients/new" modelAttribute="clientDto">
		  ...
		  <div class="form-group">
            <label for="passwordConfirmationInput" class="control-label col-sm-4 col-xs-12">Confirmação da senha * </label>
            <div class="col-sm-8 col-xs-12">
